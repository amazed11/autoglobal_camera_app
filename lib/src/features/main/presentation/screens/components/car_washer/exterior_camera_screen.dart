...
class ExteriorCameraScreen extends StatefulWidget {
  const ExteriorCameraScreen({super.key});

  @override
  State<ExteriorCameraScreen> createState() => ExteriorCameraScreenState();
}

class ExteriorCameraScreenState extends State<ExteriorCameraScreen> {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          if (((getIt<CameraCubit>().state.exteriorPhotos?.length ?? 0) +
                  (imagesList.length)) >=
              6) {
            errorToast(msg: "You reached limit for maximum photos i.e. 6/6");
            return;
          }
          takePicture();
        },
                    ...
                    GestureDetector(
                      onTap: () {
                        if (imagesList.isNotEmpty) {
                          getIt<CameraCubit>().addExteriorPhotos(imagesList);
                          context.pop();
                        } else {
